...
#[AsCommand(
    name       : 'app:orange-gnome-update',
    description: 'Update random OrangeGnome',
)]
class UpdateOrangeGnomeCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $orangeGnome->changeData();
        $orangeGnome->changeOtherData();
